...
@section('content')
    <div class="card">
        <div class="card-header border-bottom">
            ...
            <form action="{{route('dashboard.update-User',$saveuser->id)}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="card">
                    <div class="card-body">
                        <div class="border p-4 rounded">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" value="{{  $saveuser->company }}" name="company_name" class="form-control" id="inputPhoneNo2" placeholder="Phone No">
                                </div>
                            </div>
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <textarea name="phone" class="form-control" id="inputAddress4" rows="3" placeholder="Address">{{$saveuser->phone }}</textarea>
                                </div>
                            </div>
                            <div class="row mb-3">
...
{{--                                    <textarea name="designation" class="form-control" id="inputAddress4" rows="3" placeholder="Address"></textarea>--}}
                                    <select class="form-select" name="designation" aria-label="Default select example">
                                        ...
                                        <option @if($saveuser->designation=="Teacher") selected @endif value="Teacher">Teacher</option>
                                        <option @if($saveuser->designation=="Student") selected @endif value="Student">Student</option>
                                    </select>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-select" name="role" aria-label="Default select example">
                                        ...
                                        <option @if($saveuser->role=="designer") selected @endif  value="designer">designer</option>
                                        <option @if($saveuser->role=="editor") selected @endif    value="editor">editor</option>
                                        <option @if($saveuser->role=="developer") selected @endif value="developer">developer</option>
                                        <option @if($saveuser->role=="trainer") selected @endif   value="trainer">trainer</option>
                                    </select>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="file" name="image" class="form-control" id="inputAddress4" rows="3" placeholder="Address">{{$saveuser->image}}</input>
                                </div>
                            </div>

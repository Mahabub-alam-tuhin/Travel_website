...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="dark-style layout-navbar-fixed layout-menu-fixed" dir="ltr" data-theme="theme-default" data-assets-path="/adminAsset/" data-template="vertical-menu-template-dark">
    <head>
        <meta charset="utf-8" />
        ...
        <link rel="stylesheet" href="/adminAsset/vendor/css/rtl/theme-default-dark.css" class="template-customizer-theme-css" />
